...
export default function ResearcherTemplate({ siteData, activeTheme }: any) {
          ...
          <motion.div variants={fadeInUp} className="lg:col-span-4 flex justify-center lg:justify-end">
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              ...
              <div className="absolute inset-0 rounded-full overflow-hidden border border-white/10 group">
                <img src={siteData.hero.avatar} className="w-full h-full object-cover grayscale brightness-50 group-hover:grayscale-0 group-hover:brightness-100 transition-all duration-700" alt="Srujan Reddy" />
              </div>
            </div>
          </motion.div>
        </section>
